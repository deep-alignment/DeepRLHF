    ...
    def __init__(
        ...
        if self.strategy.args.use_wandb and self.strategy.is_rank_0():
            ...
            wandb.init(
                ...
                name="RM_M_" + str(strategy.args.pretrain) + "_D_" + str(strategy.args.dataset) + "_" + "mbs" + str(strategy.args.mirco_batch_size) + "_" + str(strategy.args.max_epochs) + "epoch" + "_" + str(strategy.args.wandb_run_name),
